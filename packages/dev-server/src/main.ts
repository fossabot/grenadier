...
import { getConfig, getPaths } from "@grenadierjs/internal";
...
const API_DIR = path.join(grenadierPaths.base, "api");
...
args.option("host", "", grenadierConfig.api.host || "localhost")
	.option("port", "", grenadierConfig.api.port)
	.option(
		"path",
		"The path to your lambda functions",
		grenadierPaths.api.functions
	);
