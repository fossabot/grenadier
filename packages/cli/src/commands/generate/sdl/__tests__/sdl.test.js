...
test("creates a multi word sdl file", async () => {
	...
	expect(
		files["/path/to/project/api/src/graphql/userProfiles.sdl.js"]
	).toEqual(loadGeneratorFixture("sdl", "multiWordSdl.js"));
});
...
test("creates a multi word sdl file with CRUD actions", async () => {
	...
	expect(
		files["/path/to/project/api/src/graphql/userProfiles.sdl.js"]
	).toEqual(loadGeneratorFixture("sdl", "multiWordSdlCrud.js"));
});
